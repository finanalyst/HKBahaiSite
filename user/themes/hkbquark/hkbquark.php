...
class HKBQuark extends Quark
{
    ...
    {
        $this->grav['assets']
            ->addCss('theme://css/owl.carousel.min.css')
            ->addCss('theme://css/owl.theme.default.min.css')
            ->addCss('theme://css/sliderstyle.css');

        $this->grav['assets']
            ->addJs('theme://js/owl.carousel.min.js',0)
            ->addJs('theme://js/slider.jquery.js',0);
    }
